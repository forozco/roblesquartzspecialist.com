...
echo "🔄 Paso 6/10: Reiniciando contenedor..."
...
echo "👤 Paso 9/10: Creando usuario administrador..."
...
# Step 10: Install Node dependencies and compile assets
echo "🎨 Paso 10/10: Compilando assets (esto puede tomar unos minutos)..."
